...
public class ActiveRecord implements Map<String, String>, Cachable{
    ...
    public boolean containsKey(Object o)    { return data.containsKey(o); }
    public boolean containsValue(Object o)  { return data.containsValue(o); }
    public String get(Object o)             { return data.get(o); }
    public boolean isEmpty()                { return data.isEmpty(); }
    public Set<String> keySet()             { return data.keySet(); }
    public String remove(Object o)          { return data.remove(o); }
    public int size()                       { return data.size(); }
    public Collection<String> values()      { return data.values(); }
    public Set<Entry<String, String>> entrySet()    { return data.entrySet(); }
    ...
    static private String getCacheKey(Class clazz, long id){
    ...
    static public ActiveRecord getFromCache(Class<? extends ActiveRecord> clazz, long id){
    ...
    static public ActiveRecord getInstance(Class<? extends ActiveRecord> clazz, long id){
    ...
    public String get(ActiveField activeField){  return get(activeField.getName());   }
    public String get(ActiveField activeField, String def){  return get(activeField.getName(), def);   }
