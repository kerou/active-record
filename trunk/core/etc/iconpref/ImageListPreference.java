...
public class ImageListPreference extends ListPreference {
	...
	public ImageListPreference(Context context, AttributeSet attrs) {
		...
		TypedArray typedArray = context.obtainStyledAttributes(attrs,
			Res.getIds(Application.getContext().getPackageName(), "styleable", "ImageListPreference"));
	...
	protected void onPrepareDialogBuilder(Builder builder) {
		...
		ListAdapter listAdapter = new ImageArrayAdapter(getContext(),
			Res.getId(Application.getContext().getPackageName(), "layout", "iconpref_listi_tem"), getEntries(), resourceIds, index);
